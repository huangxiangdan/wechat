  ...
  module Responder
    ...
    module ClassMethods
      ...
      def on(message_type, with: nil, respond: nil, &block)
        raise 'Unknow message type' unless %i[text image voice video shortvideo link event click view scan batch_job location label_location fallback component_verify_ticket miniprogrampage].include?(message_type)
